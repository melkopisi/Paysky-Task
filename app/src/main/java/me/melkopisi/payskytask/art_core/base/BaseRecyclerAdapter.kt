 ...
 */
abstract class BaseRecyclerAdapter<MODEL : Any, VIEW_BINDING : ViewBinding, VIEW_HOLDER : BaseViewHolder<MODEL, VIEW_BINDING>>(callback: DiffUtil.ItemCallback<MODEL>) :
